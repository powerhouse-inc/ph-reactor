...
| 5 | Benchmark: `tests/multiproc_bench.rs` (store throughput + 2-node convergence), before/after | done | `82f5d99` |
| 6 | Verification: clippy + full workspace tests; multi-process assessment in the report | done | `82f5d99` |
